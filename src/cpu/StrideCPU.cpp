...
StrideCPU::StrideCPU(sc_module_name name, unsigned bInByte, 
	unsigned freqInMHz, Terminator& t, uint64_t A, uint64_t S,
	uint64_t B, uint64_t W, uint64_t R, bool sR)
...
void StrideCPU::peqCallback(tlm::tlm_generic_payload& gp, 
